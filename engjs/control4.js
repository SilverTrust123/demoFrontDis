document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⚡ 1. Unified DEFAULT_PARAMS to align baseline across pages
    ...
    // ⚡ Keep metal sequence (S1~S24) for capacity calculation only
    ...
    const controllers = [];
    // 5 parameters specific to control4 (Rotary Cylinder)
    ...
    controlRows.forEach((row, index) => {
        ...
        // ⚡ Fix: Use DEFAULT_PARAMS for initial value
    ...
    // ⚡ Calculate cycle time using metal sequence only
    ...
    // ⚡ Update metal hourly output only
    function updateUPH() {
    ...
    // Check value changes and calculate preview metal output
